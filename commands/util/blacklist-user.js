...
module.exports = class BlacklistUserCommand extends Command {
	...
	async run(msg, args) {
		...
		if (blacklist.includes(user.id)) {
			return msg.reply('that user is already blacklisted.');
		}
		...
		return msg.reply(`${user.username}#${user.discriminator} has been blacklisted from using ${this.client.user.username}.`);
	}
};
